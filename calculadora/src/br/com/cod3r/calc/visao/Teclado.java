...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		GridBagLayout layout = new GridBagLayout(); //+flexivivel porem tem que ter as constrais
		...
		// linha 1
		c.gridwidth = 2;
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0 ); // ac vai ocupar 2 espacos
		c.gridwidth = 1; /// vai ocupar 1 espaco
